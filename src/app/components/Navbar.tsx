            ...
            <div className='mx-auto flex items-center justify-around'>
                ...
                <HoverBorderGradient
                    ...
                    <ul className='flex gap-5 items-center'>
                        <li ><a href="https://www.linkedin.com/in/govinda-shah-536ba4247/" target="_blank" rel="noopener noreferrer" className='cursor-pointer' ><Linkedin /></a></li>
                        <li ><a href="https://github.com/shahgovinda" target="_blank" rel="noopener noreferrer" className='cursor-pointer' ><Github /></a></li>
