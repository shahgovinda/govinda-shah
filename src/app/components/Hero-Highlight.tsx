    ...
    return (
        <HeroHighlight id="home" >
            ...
            >
                ...
                <p className="text-sm md:text-lg font-normal lg:font-semibold tracking-wide">Building beautiful and functional user interfaces that leave a lasting impression.</p>
