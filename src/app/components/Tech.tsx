...
import { DockerIcon, TypescriptIcon, NodeIcon, ExpressIcon, GitIcon, HtmlIcon, JsIcon, NextIcon, ReactIcon, TailwindIcon, MongoDbIcon, VercelIcon, FirebaseIcon, VscodeIcon } from './icons'; // Added new icons
...
        { id: '4', component: GitIcon },
        { id: '5', component: HtmlIcon },
        { id: '6', component: TypescriptIcon },
        { id: '7', component: MongoDbIcon }, // New
        { id: '8', component: FirebaseIcon }, // New
        { id: '9', component: VercelIcon }, // New
        { id: '10', component: VscodeIcon }, // New
...
    return (
        <div>
            <div id='techstack' className="  py-64 z-0 bg-black   bg-grid-white/[0.2] relative  w-full">
